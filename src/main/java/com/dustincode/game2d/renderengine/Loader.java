...
public class Loader {
    ...
    private static final int LENGTH_OF_EACH_VERTEX = 3;
     ...
     *
     * @param positions
     *            - The 2D or 3D positions of each vertex in the geometry.
    ...
    private static void storeDataInAttributeList(int attributeNumber, float[] data) {
        ...
        GL20.glVertexAttribPointer(attributeNumber, LENGTH_OF_EACH_VERTEX, GL11.GL_FLOAT, false, 0, 0);
     ...
     */
    private static FloatBuffer storeDataToFloatBuffer(float[] data) {
